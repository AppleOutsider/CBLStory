...
class Chapter3_2Data {
    static let dataList: [MainViewData] = [
        ...
        MainViewData(leftImage: "",
                     ...
                     peopleDirection: .center,
                     talkingPersonDirection: .center,
                     lineModels: LineModels(names: "내레이션", lines: "해그위드 입에는 '애플나무 지팡이'가 물려있다.")),
        MainViewData(leftImage: "",
                     centerImage: "hed_scream",
                     rightImage: "" ,
                     bgImage: "bg12",
                     peopleDirection: .center,
                     talkingPersonDirection: .center,
                     lineModels: LineModels(names: "해그위드", lines: "부엉! 부엉! 부엉!(어서 받아!!)", soundEffect: "mc1_sound_owl")),
        MainViewData(leftImage: "ron_scream",
                     ...
                     peopleDirection: .center,
                     talkingPersonDirection: .center,
                     lineModels: LineModels(names: "해리포터", lines: "고마워 해그위드!! 루모스!!")),
        MainViewData(leftImage: "ron_scream",
                     centerImage: "harry_scream",
                     rightImage: "her_scream" ,
                     bgImage: "bg12",
        ...
        MainViewData(leftImage: "",
                     ...
                     peopleDirection: .center,
                     talkingPersonDirection: .center,
                     lineModels: LineModels(names: "내레이션", lines: "말포이를 둘러싸고 있는 에너지가 포스트잇으로 되돌아간다.",soundEffect: "mc1_sound_postit.mp3")),
        MainViewData(leftImage: "",
                     centerImage: "mal_sad",
                     rightImage: "" ,
                     bgImage: "bg12",
                     peopleDirection: .center,
                     talkingPersonDirection: .center,
                     lineModels: LineModels(names: "말포이", lines: "크아아아아~"))
